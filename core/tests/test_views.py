...
#             username='admin', password='admin123', role='teacher', is_superuser=True
#         )

#         # Create Teacher
#         self.teacher_user = User.objects.create_user(
#             username='teacher1', password='testpass', role='teacher'
#         )
...
class ViewsTestCase(APITestCase):
    ...
    def test_teacher_get_own_students(self):
        ...
        # print(response.data)
        # assigned_students = [s for s in response.data if s['assigned_teacher'] == self.teacher.id]
